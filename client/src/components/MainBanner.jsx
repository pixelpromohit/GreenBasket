...
const MainBanner = () => {
  return (
    <div className='relative'>
        {/* for medium screens display big banner */}
      <img src={assets.main_banner_bg} alt="banner" className='w-full hidden md:block'/>
        {/* for small screens display small banner */}
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end
        ...
        <h1 className='text-3x1 md:text-4xl lg:text-5xl font-bold text-center md:text-left
